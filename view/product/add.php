...
<body>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" id="validationCustom01" name="name_sp"  required>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <input type="number" class="form-control" id="validationCustom02" name="price_sp"  required>
            <div class="invalid-feedback">
             Mời nhập giá
            </div>
        </div>
    ...
    <div class="col-md-5">
        <label for="validationCustom04" class="form-label" name="id_dm">Danh mục</label>
        ...
        ?>
            ...
            <option value="<?php echo $id_dm ?>"><?php echo $name_dm ?></option>
        <?php
            }
        ?>
        </select>
