...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" id="validationCustom01" value="<?php echo $name_sp ?>" name="name_sp"  required>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <input type="number" class="form-control" id="validationCustom02" value="<?php echo $price_sp ?>" name="price_sp"  required>
            <div class="valid-feedback">
            Looks good!
            </div>
        </div>
    ...
    <select class="form-select" name="id_dm" id="validationCustom04" required>
        <?php foreach ($listcategory as $category) {
            extract($category); ?>
        <?php
        if ($oneProduct['id_dm'] == $category['id_dm']) {?>
            <option selected value="<?=$id_dm?>"><?=$name_dm?>
        </option>
     <?php }else{?>
            <option value="<?=$id_dm?>"><?=$name_dm?></option>
    <?php } ?>
   <?php } ?>
    </select>
    <div class="invalid-feedback">
