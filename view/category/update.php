...
<body>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <input type="text" class="form-control" id="validationCustom01" value="<?php echo $name_dm ?>" name="name_dm"  required>
    ...
    <?php
    if(isset($thongbao)){
        $thongbao = htmlspecialchars($thongbao); // Đảm bảo rằng $thongbao không chứa mã HTML độc hại
        echo "<script>document.addEventListener('DOMContentLoaded', function() { 
            var div = document.createElement('div');
            div.textContent = '$thongbao';
